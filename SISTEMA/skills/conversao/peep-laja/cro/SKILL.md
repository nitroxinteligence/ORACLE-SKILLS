---
name: oracle-skill-3150fad77923b27d8048
description: "Diagnosticar fricções de páginas e formulários e priorizar hipóteses. Use em Conversão / Funis."
metadata:
  departamento: conversao
  especialista: peep-laja
  skill-id: CNV-FUN-01
---
...
Ative a orientação de [[SISTEMA/recursos-skills/perfis/peep-laja-funis/perfil|Peep Laja — Funis]] para esta habilidade. Localize esse caminho a partir da raiz do vault, e leia o perfil antes de executar. A identidade é de IA com atribuição; o resultado deve refletir o método, não inventar a pessoa real.
...
Leve: evidência por achado e fila de experimentos.
