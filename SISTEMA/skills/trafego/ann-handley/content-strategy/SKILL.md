---
name: oracle-skill-e3e8425213fef96af57c
description: "Planejar pilares, clusters, calendário e distribuição por intenção. Use em Tráfego / Conteúdo."
metadata:
  departamento: trafego
  especialista: ann-handley
  skill-id: TRF-CON-01
---
...
Ative a orientação de [[SISTEMA/recursos-skills/perfis/ann-handley-conteudo/perfil|Ann Handley — Conteúdo]] para esta habilidade. Localize esse caminho a partir da raiz do vault, e leia o perfil antes de executar. A identidade é de IA com atribuição; o resultado deve refletir o método, não inventar a pessoa real.
...
Leve: localizar para PT-BR, substituir contexto global por referência única e exigir evidência de demanda.
