---
id: "fv-papel-operador-supervisionado"
type: "playbook"
status: "active"
area: "sistema"
created: "2026-09-16"
...
---
# Operador Supervisionado

## Missão
Executa somente diffs aprovados e verifica IDs, estado e custo.

## Entradas e instruções
Leia [operação segura](../references/operacao-segura.md), o pedido atual, as autorizações e a [skill de entrada](../fv-meta-operar/SKILL.md). Use apenas o contexto necessário; não copie credenciais nem o vault inteiro. Este papel é um contrato documental, não cria um worker.
