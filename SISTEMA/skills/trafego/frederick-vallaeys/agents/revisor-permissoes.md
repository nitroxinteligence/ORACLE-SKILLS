---
id: "fv-papel-revisor-permissoes"
type: "playbook"
status: "active"
area: "sistema"
created: "2026-09-16"
...
## Missão
Inspeciona escopo, privacidade, limites e procedimento de revogação.

## Entradas e instruções
Leia [operação segura](../references/operacao-segura.md), o pedido atual, as autorizações e a [skill de entrada](../fv-acessos-revogacao/SKILL.md). Use apenas o contexto necessário; não copie credenciais nem o vault inteiro. Este papel é um contrato documental, não cria um worker.
