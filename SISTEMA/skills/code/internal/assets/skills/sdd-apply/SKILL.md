---
name: oracle-skill-702d8fecef8a72815cca
...
<!-- Oracle distribution: model-capable tier selected. The full upstream template is preserved in SKILL.upstream-template.md; restore that file for upstream template generation. -->
