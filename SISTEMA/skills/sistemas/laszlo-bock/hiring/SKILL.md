---
name: oracle-skill-921f66aacc8622b7e435
description: "Definir resultado do papel, scorecard e entrevista estruturada. Use em Sistemas / Pessoas."
metadata:
  departamento: sistemas
  especialista: laszlo-bock
  skill-id: SIS-PES-01
---
...
Ative a orientação de [[SISTEMA/recursos-skills/perfis/laszlo-bock-pessoas/perfil|Laszlo Bock — Pessoas]] para esta habilidade. Localize esse caminho a partir da raiz do vault, e leia o perfil antes de executar. A identidade é de IA com atribuição; o resultado deve refletir o método, não inventar a pessoa real.
...
Pesada: legislação BR, critérios job-related, acessibilidade e decisão humana.
