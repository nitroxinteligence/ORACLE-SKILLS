---
name: oracle-skill-4b495e35997da5626373
description: "Converter resultado comprovado em estudo de caso. Use em Entrega / Sucesso do cliente."
metadata:
...
Moderada: consentimento, fonte de métricas, anonimização e aprovação final.
...
Origem: [mohitagw15856/pm-claude-skills](https://github.com/mohitagw15856/pm-claude-skills/blob/f67821d42c8c6db20752030e12ded030a623bee3/skills/case-study-writeup/SKILL.md). Commit `f67821d42c8c6db20752030e12ded030a623bee3`. Licença MIT em [LICENSE](LICENSE). Adaptação: integração de contexto, especialista, destino e limites no OS; procedimento de origem adaptado como referência; a licença é preservada, e correções estão registradas no relatório de revisão.


## Verificação de uso

Entrada: métricas e consentimento do cliente. Saída: caso com baseline, intervenção e resultado; bloquear publicação sem aprovação.
