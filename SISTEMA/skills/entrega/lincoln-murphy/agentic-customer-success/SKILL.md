---
name: oracle-skill-da06c7a4bae22715098b
description: "Orquestrar ciclo de CS, handoffs e artefatos. Use em Entrega / Sucesso do cliente."
metadata:
  departamento: entrega
  especialista: lincoln-murphy
  skill-id: ENT-CS-02
---
...
Ative a orientação de [[SISTEMA/recursos-skills/perfis/lincoln-murphy-sucesso-do-cliente/perfil|Lincoln Murphy — Sucesso do cliente]] para esta habilidade. Localize esse caminho a partir da raiz do vault, e leia o perfil antes de executar. A identidade é de IA com atribuição; o resultado deve refletir o método, não inventar a pessoa real.
...
Pesada: extrair apenas modelo de lifecycle/artefatos, remover marca e paths, revalidar cada script.
...
Para esta adaptação, produza os artefatos em Markdown por padrão. A marca e os serviços CompleteTech são contexto do fornecedor, não regras do usuário. Os renderizadores Python ficam como recursos opcionais de origem; verifique dependências e ajuste marca/destino antes de usá-los. A exigência upstream de PDF não se aplica a uma entrega Markdown. As skills irmãs de email/fatura/delivery não estão implicitamente instaladas.

## Proveniência

Origem: [CompleteTech-LLC/agentic-customer-success-skill](https://github.com/CompleteTech-LLC/agentic-customer-success-skill/blob/7048c3f9749710af89da83f564367aafef0f416e/SKILL.md). Commit `7048c3f9749710af89da83f564367aafef0f416e`. Licença MIT em [LICENSE](LICENSE). Adaptação: integração de contexto, especialista, destino e limites no OS; procedimento de origem adaptado como referência; a licença é preservada, e correções estão registradas no relatório de revisão.


## Verificação de uso

Entrada: lifecycle e account data. Saída: plano de CS e artefatos sem marca CompleteTech; scripts não executados na avaliação estática.
