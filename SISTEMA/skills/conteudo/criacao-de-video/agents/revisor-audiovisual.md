---
id: "video-papel-revisor-audiovisual"
type: "playbook"
status: "active"
area: "sistema"
created: "2026-09-16"
...
## Missão
Distingue revisão amostral, reprodução completa e validação de exportação.

## Entradas e instruções
Leia [operação segura](../references/operacao-segura.md), o pedido atual, as autorizações e a [skill de entrada](../video-revisao-exportacao/SKILL.md). Use apenas o contexto necessário; não copie credenciais nem o vault inteiro. Este papel é um contrato documental, não cria um worker.
