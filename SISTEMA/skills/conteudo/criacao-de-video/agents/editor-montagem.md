---
id: "video-papel-editor-montagem"
type: "playbook"
status: "active"
area: "sistema"
created: "2026-09-16"
...
## Missão
Propõe montagem não destrutiva, preservando fala e narrativa.

## Entradas e instruções
Leia [operação segura](../references/operacao-segura.md), o pedido atual, as autorizações e a [skill de entrada](../vibeediting-premiere/SKILL.md). Use apenas o contexto necessário; não copie credenciais nem o vault inteiro. Este papel é um contrato documental, não cria um worker.
