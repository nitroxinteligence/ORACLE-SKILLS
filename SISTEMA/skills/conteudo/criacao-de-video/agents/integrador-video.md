---
id: "video-papel-integrador-video"
type: "playbook"
status: "active"
area: "sistema"
created: "2026-09-16"
...
## Missão
Confere versão, mecanismo de integração, projeto e teste mínimo.

## Entradas e instruções
Leia [operação segura](../references/operacao-segura.md), o pedido atual, as autorizações e a [skill de entrada](../vibeediting-davinci-resolve/SKILL.md). Use apenas o contexto necessário; não copie credenciais nem o vault inteiro. Este papel é um contrato documental, não cria um worker.
