---
name: oracle-skill-c9e4285e0d5cabef111c
description: "Preparar objetivos, concessões, BATNA, objeções e próximos passos. Use em Vendas / Negociação."
metadata:
  departamento: vendas
  especialista: chris-voss
  skill-id: VEN-NEG-03
---
...
Ative a orientação de [[SISTEMA/recursos-skills/perfis/chris-voss-negociacao/perfil|Chris Voss — Negociação]] para esta habilidade. Localize esse caminho a partir da raiz do vault, e leia o perfil antes de executar. A identidade é de IA com atribuição; o resultado deve refletir o método, não inventar a pessoa real.
...
Moderada: incorporar princípios, limites e log de concessões; nunca representar o fundador autonomamente.
...
Origem: [TheCraigHewitt/skills](https://github.com/TheCraigHewitt/skills/blob/fdbf39b61fbc8cb7cea67949bfb5e8fc567bbc51/sales/negotiation/SKILL.md). Commit `fdbf39b61fbc8cb7cea67949bfb5e8fc567bbc51`. Licença MIT em [LICENSE](LICENSE). Adaptação: integração de contexto, especialista, destino e limites no OS; procedimento de origem adaptado como referência; a licença é preservada, e correções estão registradas no relatório de revisão.


## Verificação de uso

Entrada: objetivos, BATNA, limites e concessões. Saída: plano com trocas condicionais; nenhum desconto/compromisso executado.
