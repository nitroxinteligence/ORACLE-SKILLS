---
name: oracle-skill-a0f52b02f1177cc46577
description: "Produzir proposta/SOW com opções, escopo e próximos passos. Use em Vendas / Fechamento."
metadata:
  departamento: vendas
  especialista: neil-rackham
  skill-id: VEN-FEC-02
---
...
Ative a orientação de [[SISTEMA/recursos-skills/perfis/neil-rackham-fechamento/perfil|Neil Rackham — Fechamento]] para esta habilidade. Localize esse caminho a partir da raiz do vault, e leia o perfil antes de executar. A identidade é de IA com atribuição; o resultado deve refletir o método, não inventar a pessoa real.
...
Pesada: moeda, impostos, LGPD, revisão jurídica e aprovação do preço.
