...
5. Submit a pull request using the appropriate template:
   - New Skill (recurso externo: ?template=new-skill.md; não incluído nesta distribuição)
   - Skill Update (recurso externo: ?template=skill-update.md; não incluído nesta distribuição)
   - Documentation (recurso externo: ?template=documentation.md; não incluído nesta distribuição)
