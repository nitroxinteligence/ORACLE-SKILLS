...
This is the *paid-social creative research* cut. For structured competitor dossiers from a URL list, hand off to [competitor-profiling](../../competitor-profiling/SKILL.md). For deep voice-of-customer analysis and JTBD, hand off to [customer-research](../../customer-research/SKILL.md). Persona output feeds positioning (recurso externo: ../../positioning/SKILL.md; não incluído nesta distribuição).
...
- **Personas doc →** shared context for [customer-research](../../customer-research/SKILL.md), [copywriting](../../copywriting/SKILL.md), and positioning (recurso externo: ../../positioning/SKILL.md; não incluído nesta distribuição).
