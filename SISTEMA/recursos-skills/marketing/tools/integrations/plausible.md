...

{
  ...
  "date_range": "30d",
  "filters": "is", "event:page", ["/pricing" (consulte no contexto do projeto, se disponível)]
}
```
...
- `order_by` - Array of sort specs: `metric, "desc" (consulte no contexto do projeto, se disponível)`
